...
class PasteSmsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PasteSmsScreen> createState() => _S();
}

class _S extends ConsumerState<PasteSmsScreen> {
  ...
  Future<void> _save() async {
    ...
    await ref.read(addTransactionProvider)(Transaction(
      ...
      date: DateTime.now(), source: 'manual_sms',
    ));
    if (mounted) { 
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: !canEdit ? _buildViewOnly() : SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('Paste UPI SMS here', style: AppTextStyles.label),
